...
int main() {
  ...
  while (cin) {
    ...
    cout<<"Bonjour, bienvenu sur le projet Multimedia, les commandes à utiliser sont les suivantes: "<<endl;
    cout<<"chercher <args>: chercher un objet ou un groupe en donnant le nom en args"<<endl;
    cout<<"jouer <args> : jouer une photo, video ou film en donnant le nom en args"<<endl;
    cout<<"exit : finir la connection"<<endl;
